...
import video36Parser from './parsers/video36.js';
...
import tableNoHeader44Parser from './parsers/tableNoHeader44.js';
  ...
  transform: async (payload) => {
    ...
    if (fragName) {
      ...
      transformFragment(main, {
        ...payload, fragment, inventory, reportBuilder,
      });
      path = fragment.path;
    } else {
      // page transformation
