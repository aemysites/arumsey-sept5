...
## Environments
- Preview: https://main--arumsey-sept5--aemysites.aem.page/
- Live: https://main--arumsey-sept5--aemysites.aem.live/
- Block Library: https://main--arumsey-sept5--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `arumsey-sept5` directory in your favorite IDE and start coding :)
